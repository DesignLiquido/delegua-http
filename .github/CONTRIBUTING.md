...
Qualquer pessoa pode sugerir melhoramentos para a biblioteca ou correções de bugs. Uma recomendação é abrir uma _issue_ no GitHub antes, para colher a opinião da comunidade e evitar rejeições de contribuições. 
...
Isso deve baixar e instalar os pacotes que esta biblioteca precisa para ser desenvolvida.

Delégua e suas bibliotecas funcionam em qualquer sistema operacional que tenha uma versão de Node.js compatível. 
